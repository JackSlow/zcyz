...
<body>
	...
	<div class="cart-items">
		...
		<div class="container">
			...
			<h2 style="font-family: '幼圆'">我的订单</h2>
			<% =orders %>
<%--		<div id="box" style="height:150px; width:100%; border:1px solid #999999;">
	     <% =pic %>
			  <div class="tupian" style=" width:120px; height:120px; margin-top:14px; margin-left:15px; border:1px solid #999999; float:left">
			  <img src="../images/photo/1.jpg" alt="" />
			  </div>
			  <p style="margin-top:14px; text-indent:20px">ddd</p>
			  <p style="margin-top:7px; text-indent:20px">rfgffg</p>
			   <p style="margin-top:7px; text-indent:20px">rfgffg</p>
			    <p style="margin-top:7px; text-indent:20px">rfgffg</p>
			</div>--%>
