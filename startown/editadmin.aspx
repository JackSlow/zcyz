                        ...
                        <div class="well brown">
                         <form action="#">
                            ...
                            <div class="form_list"><label class="lable_title">状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="ql" value="2">&nbsp;&nbsp;用户&nbsp;&nbsp;&nbsp;<input type="radio" name="ql" value="1">&nbsp;&nbsp;普通管理员&nbsp;&nbsp;<input type="radio" name="ql" value="0">&nbsp;&nbsp;超级管理员</div>
                             <input type="text" runat="server" name="txt_power" id="txt_power" style="display: none"/>

                            <div class="form_list">


                                <input type="submit" class="submit" value="&nbsp;&nbsp;提&nbsp;&nbsp;交&nbsp;&nbsp;" id="Submit1" runat="server" onserverclick="Submit1_ServerClick"/>
                            </div>
                         </form>   
    ...
    <script src="js/bootstrap.js"></script>
         ...
         <script>
            ...
            function Init() {
                ...
                var ql = $("#txt_power").val();
                $("input[name=ql]").eq(ql).attr("checked", 'checked');//设置角色勾选
